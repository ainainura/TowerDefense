...
public class ProjectileDeathTower extends DrawableImage {

	private int speed;
	private Monster monster;
	private DeathTower tower;

	private int monsterXCoord;
	private int monsterYCoord;

	public ProjectileDeathTower(DrawingPanel drawArea, String imageFile,
			DeathTower tower, Monster monster, int speed, int width, int height) {
	...
	public DeathTower getTower() {
		return tower;
	}

	public void setTower(DeathTower tower) {
		this.tower = tower;
	}
