...
public class ProjectileArrowTower extends DrawableImage {
	...
	public ProjectileArrowTower(DrawingPanel drawArea, String imageFile,
			ArrowTower tower, Monster monster, int speed, int width, int height) {
	...
	public ArrowTower getTower() {
		return tower;
	}

	public void setTower(ArrowTower tower) {
		this.tower = tower;
	}
