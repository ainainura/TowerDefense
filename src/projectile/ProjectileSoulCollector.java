...
public class ProjectileSoulCollector extends DrawableImage {

	private int speed;
	private Monster monster;
	private SoulCollectorTower tower;

	private int monsterXCoord;
	private int monsterYCoord;

	public ProjectileSoulCollector(DrawingPanel drawArea, String imageFile,
			SoulCollectorTower tower, Monster monster, int speed, int width,
			int height) {
	...
	public SoulCollectorTower getTower() {
		return tower;
	}

	public void setTower(SoulCollectorTower tower) {
		this.tower = tower;
	}
