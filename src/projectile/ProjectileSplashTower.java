...
public class ProjectileSplashTower extends DrawableImage {
	...
	public ProjectileSplashTower(DrawingPanel drawArea, String imageFile,
			SplashTower tower, Monster monster, int speed, int width, int height) {
	...
	public SplashTower getTower() {
		return tower;
	}

	public void setTower(SplashTower tower) {
		this.tower = tower;
	}
