...
public class DeathTower extends DrawableImage {
	...
	public int damage;
	public int range;
	public int deathDealingChance; // 5 stands for 5% chance, 20 for 20% and so
									// on

	public DeathTower(DrawingPanel drawArea, String imageFile, int damage,
			int range, int deathDealingChance, int attackSpeed, int xCoor,
			int yCoor, int cost) {
